...
public:
	...
	player_t* m_hBombDefuser() {
		auto bombdefuser = (UINT*)((uintptr_t)this + (netvar_manager::get_net_var(fnv::hash("DT_PlantedC4"), fnv::hash("m_hBombDefuser"))));
		return reinterpret_cast<player_t*>(bombdefuser);
	}
